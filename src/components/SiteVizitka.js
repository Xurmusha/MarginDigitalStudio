                    ...
                    <div className="col-12 ">
                        <div className={`card border-0 ${props.class}`}>
                            <div className="card-body py-2">
                                <div className="row">
                                    <div style={{backgroundImage: "linear-gradient(90deg, " + props.color1 + ',' + props.color2 + ")"}}
                                         className="form w-100 p-0 text-white" onClick={() => {props.history.push("/Visit")}}>
